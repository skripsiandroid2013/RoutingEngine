...
public class Node {
	...
	public List<Way> getSourceAdjacencies() {
		if (sourceAdjacencies == null) {
			...
			List<Way> sourceAdjacenciesNew = targetDao
					._queryNode_SourceAdjacencies(nodeID);
			synchronized (this) {
				if (sourceAdjacencies == null) {
	...
	public List<Way> getTargetAdjacencies() {
		if (targetAdjacencies == null) {
			...
			WayDao targetDao = daoSession.getWayDao();
			List<Way> targetAdjacenciesNew = targetDao
					._queryNode_TargetAdjacencies(nodeID);
			synchronized (this) {
				if (targetAdjacencies == null) {
	...
	public Point getPoint() {
		Point p = new GeometryFactory().createPoint(new Coordinate(Double
				.valueOf(longitude), Double.valueOf(latitude)));
